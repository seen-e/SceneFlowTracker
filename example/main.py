...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--yolo-devices", default=None, help="覆盖 YOLO GPU 编号列表，逗号分隔，例如 0,1。")
    ...
    parser.add_argument("--cotracker-devices", default=None, help="覆盖 CoTracker GPU 编号列表，逗号分隔，例如 0,1。")
